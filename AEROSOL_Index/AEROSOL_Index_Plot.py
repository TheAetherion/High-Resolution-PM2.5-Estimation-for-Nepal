...
# ── File Paths ────────────────────────────────────────────────────────
nc_file        = r"C:\Users\samue\Documents\Conferences\Space\AEROSOL_Index\AEROSOL_Index_Data.nc"
...
data_var = prod.variables['aerosol_index_354_388'][0, :, :].flatten()
...
cbar.set_label('Aerosol Index (unitless)', fontsize=9, labelpad=8)
cbar.ax.tick_params(labelsize=8)

ax.set_title('UV Aerosol Index (UVAI) Concentration', fontsize=12,
             fontweight='bold', pad=10)

plt.savefig('AEROSOL_Index_Plot.png', dpi=300, bbox_inches='tight', pad_inches=0.15)
plt.show()
print("Saved → AEROSOL_Index_Plot.png")
