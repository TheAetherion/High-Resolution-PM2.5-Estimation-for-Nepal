...
# ── File Paths ────────────────────────────────────────────────────────
nc_file        = r"C:\Users\samue\Documents\Conferences\Space\SO2\SO2_Data.nc"
...
data_var = prod.variables['sulfurdioxide_total_vertical_column'][0, :, :].flatten()
...
cbar.set_label(r'SO$_2$ Column (mol m$^{-2}$)', fontsize=9, labelpad=8)
cbar.ax.tick_params(labelsize=8)

ax.set_title(r'Sulfur Dioxide (SO$_2$) Concentration', fontsize=12,
             fontweight='bold', pad=10)

plt.savefig('SO2_Plot.png', dpi=300, bbox_inches='tight', pad_inches=0.15)
plt.show()
print("Saved → SO2_Plot.png")
