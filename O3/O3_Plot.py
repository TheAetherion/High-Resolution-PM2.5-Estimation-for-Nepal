...
# ── File Paths ────────────────────────────────────────────────────────
nc_file        = r"C:\Users\samue\Documents\Conferences\Space\O3\O3_Data.nc"
...
data_var = prod.variables['ozone_total_vertical_column'][0, :, :].flatten()
...
cbar.set_label(r'O$_3$ Column (mol m$^{-2}$)', fontsize=9, labelpad=8)
cbar.ax.tick_params(labelsize=8)

ax.set_title(r'Ozone (O$_3$) Concentration', fontsize=12,
             fontweight='bold', pad=10)

plt.savefig('O3_Plot.png', dpi=300, bbox_inches='tight', pad_inches=0.15)
plt.show()
print("Saved → O3_Plot.png")
